<?php
	...
	/* Connect To Database*/
	require_once ("../php/conexion5.6.php");
...
if($action == 'ajax'){
	...
	$tables="socio";
	$campos="*";
	$sWhere=" apellido LIKE '%".$query."%'";
	$sWhere.=" order by apellido";
	
	
	include 'pagination.php'; //include pagination file
	//pagination variables
	$page = (isset($_REQUEST['page']) && !empty($_REQUEST['page']))?$_REQUEST['page']:1;
        //$per_page = (isset($_REQUEST['per_page']) && !empty($_REQUEST['per_page']))?$_REQUEST['per_page']:1;
			...
			<table class="table table-striped table-hover">
				...
				<tbody>	
						...
						<tr class="<?php echo $text_class;?>">
							...
							<td class='text-right'><?php echo $cliente_telefono;?></td>
							<td>
