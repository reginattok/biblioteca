...
<body>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
              ...
              <select class="" name="precio" id="precio">
	...
	<!-- Edit Modal HTML -->
	<?php include("html/productos_modal_add.php");?>
	<!-- Edit Modal HTML -->
	<?php include("html/productos_modal_edit.php");?>
	<!-- Delete Modal HTML -->
	<?php include("html/productos_modal_delete.php");?>
